    ...
    async function loadDocs() {
      ...
      try {
        ...
        if (res.ok && data.success) {
          ...
          // If initialDocId wasn't passed, select first document
    ...
    <div className="space-y-8 max-w-4xl mx-auto">
      ...
      <div className="space-y-2">
        ...
        <p className="text-sm text-slate-500">
          Compare any file against its registered SHA-256 fingerprint on the chain seam to
          ...
          <div className="space-y-2">
            ...
            {selectedDocMeta && (
              <div className="p-3 rounded-xl bg-slate-50 border border-slate-200 text-xs text-slate-500 flex flex-wrap items-center justify-between gap-2 font-mono">
                ...
                <span>
                  Registered: {new Date(selectedDocMeta.registeredAt).toLocaleDateString()}
                </span>
              </div>
            )}
          </div>
              ...
              <div className="glass-panel-emerald rounded-3xl p-6 sm:p-8 border border-emerald-200 space-y-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-emerald-700">
                      The SHA-256 fingerprint of the uploaded file strictly matches the chain
                      registry record.
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-2xl p-5 border border-emerald-200 space-y-4 font-mono text-xs">
                  ...
                  <div className="p-3 rounded-xl bg-emerald-50 border border-emerald-200 text-emerald-800 text-[11px] flex items-center justify-between">
                    <span>
                      Result Status: <strong>100% Cryptographic Match</strong>
                    </span>
              ...
              <div className="glass-panel-crimson rounded-3xl p-6 sm:p-8 border border-red-200 space-y-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <h3 className="text-2xl font-extrabold text-slate-900">
                      Does Not Match Registered Document
                    </h3>
                    <p className="text-xs text-red-700">
                      WARNING: Content in the uploaded file differs from the original registered
                      fingerprint.
                    </p>
                  </div>
                </div>

                {/* Side-by-Side Hash Mismatch */}
                <div className="bg-white rounded-2xl p-5 border border-red-200 space-y-4 font-mono text-xs">
                  ...
                  <div className="p-3 rounded-xl bg-red-50 border border-red-200 text-red-800 text-[11px]">
                    <strong>Detection Summary:</strong> SHA-256 hash output changed. One or more
                    bytes, characters, or metadata fields in this file have been altered since
                    registration.
                  </div>
                </div>
              </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-600">
                      ...
                      <code className="text-amber-800 font-mono">{verifyResult.docId}</code> was
                      found in the vault registry.
                    </p>
                  </div>
                </div>
                <div className="text-xs text-slate-500 leading-relaxed">
                  Please verify the selected Document ID from the registry or register this
                  document first.
                </div>
              </div>
            )}
